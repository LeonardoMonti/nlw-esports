...
export const CreateAdModal: React.FC = () => {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="border border-purple-400 sm2x:border-hidden bg-black/80 fixed top-1/2 left-1/2 max-h-screen w-full max-w-[480px] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-sm py-8 px-10 text-white shadow-lg shadow-black/25 sm:rounded-lg">
